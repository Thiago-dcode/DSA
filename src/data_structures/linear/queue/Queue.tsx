        ...
        <div className="flex  justify-between w-full px-4">
          <Info title="QUEUE" text={<article>
            ...
            <ul>
              ...
              <br />
              <li>
                <b className="font-semibold text-yellow-400"> Front: </b> This operation <b>returns the front element of the queue without removing it</b>. It allows you to inspect the element at the front of the queue without modifying the queue's state. This is useful when you need to see what the front element is without altering the queue. <br /><b>Time complexity: O(1).</b>
              </li>
            </ul>
          </article>
